  ...
  units: [
    {
      ...
      content: [
        { type: "callout", calloutType: "note", title: "🎯 جولة مقارنة — Java as a Comparison Tour", content: [
          { type: "p", content: "Java في هذه الوحدة (والوحدات التالية) تُستخدم كلغة مقارنة لا كلغة أساسية. لن نبني مشاريع إنتاجية بها، بل سنتعلم من خلالها كيف تتعامل اللغات الصارمة الـ Static مع التعقيد الزمني وهياكل البيانات، لنقارنها بـ Python و TypeScript التي تبنينا عليها عملياً. ركّز على فكرة الخوارزمية نفسها، لا على تفاصيل صياغة Java." }
        ]},
...
public class StudentManagementSystem {
    ...
    },
    {
      ...
      content: [
        { type: "callout", calloutType: "note", title: "🎯 جولة مقارنة — Java as a Comparison Tour", content: [
          { type: "p", content: "OOP هنا تُعرض بصياغة Java الصارمة (كلاسات مجردة، واجهات، أنواع مرجعية). قارنها بـ TypeScript في الوحدة القادمة: TypeScript تحقق نفس الركائز الأربع (التغليف، الوراثة، تعدد الأشكال، التجريد) لكن بمرونة أكبر وأنواع قابلة للاستدلال التلقائي. الفكرة واحدة، اللغة أداة." }
        ]},
...
printQueue.forEach(Printable::print);  // Method Reference` },
    ...
    },
    {
      ...
      content: [
        { type: "callout", calloutType: "note", title: "🎯 جولة مقارنة — Java as a Comparison Tour", content: [
          { type: "p", content: "نظام الاستثناءات في Java (Checked vs Unchecked, try-with-resources, Custom Exceptions) صارم ومنظّم. لاحظ كيف يفرض المترجم عليك معالجة بعض الأخطاء وقت الترجمة، بينما JavaScript/TypeScript و Python تتركان الأمر للمطوّر وقت التشغيل. الفلسفتان شرعيتان، لكن Java تربح في المشاريع المصرفية والصحّية حيث الخطأ البرمجي يعني خسارة مالية أو صحية." }
        ]},
...
class BankAccountTest {
    ...
    },
    {
      ...
      content: [
        { type: "callout", calloutType: "note", title: "🎯 جولة مقارنة — Java as a Comparison Tour", content: [
          { type: "p", content: "أوامر Git و GitHub Actions التالية عالمية ولا تخصّ لغة دون غيرها. وجودها هنا تكميلي: بعد المرور بـ Python + TypeScript + Java، نثبت أن مهارات التحكم بالإصدارات والنشر المستمر مشتركة بين كل اللغات، وهي ما يصنع المطوّر المحترف فعلاً." }
        ]},
