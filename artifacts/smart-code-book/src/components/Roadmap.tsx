    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <header className="mb-8 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          المسار التعليمي الكامل من حل المشكلات بـ Python إلى هندسة البرمجيات الاحترافية.
        </p>
...
function stageProgressionNarrative(stageNumber: number): string {
  switch (stageNumber) {
    case 1: return 'أساسيات حل المشكلات والتفكير البرمجي مع Python.';
    case 2: return 'الخوارزميات ومفاهيم البرمجة المتقدمة — جولة مقارنة مع Java.';
    case 3: return 'تطبيقات الويب، APIs، قواعد البيانات SQL وعمليات DevOps.';
    case 4: return 'الهندسة المعمارية، الجودة، والمفاهيم المهنية المتقدمة.';
    default: return '';
  }
}
